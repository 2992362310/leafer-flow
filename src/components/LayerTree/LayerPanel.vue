  ...
  >
    ...
    >
        <div class="flex items-center gap-2">
            <!-- Layers Icon -->
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 opacity-70"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
    ...
    <div class="flex-1 overflow-y-auto py-2" v-show="!isCollapsed">
       <div v-if="treeData.length === 0" class="text-center text-xs opacity-40 mt-10">
           没有图层
       </div>
