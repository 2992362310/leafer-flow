...
function onChildMoveUp(node: IUI) {
  emit("moveUp", node);
}
function onChildMoveDown(node: IUI) {
  emit("moveDown", node);
}
function onChildMoveTop(node: IUI) {
  emit("moveTop", node);
}
function onChildMoveBottom(node: IUI) {
  emit("moveBottom", node);
}
</script>
  ...
  <div class="flex flex-col select-none">
    ...
    <div v-if="isGroup" v-show="isExpanded">
      <LayerItem
        ...
        @moveUp="onChildMoveUp"
        @moveDown="onChildMoveDown"
        @moveTop="onChildMoveTop"
        @moveBottom="onChildMoveBottom"
      />
    </div>
  </div>
</template>
