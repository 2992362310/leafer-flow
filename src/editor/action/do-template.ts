...
function getStyleByType(type: TemplateNodeType) {
  ...
  if (type === "startEnd" || type === "bpmnEvent") return { ...common, fill: "#ecfdf5", stroke: "#059669" };
  if (type === "decision" || type === "bpmnGateway") return { ...common, fill: "#fffbeb", stroke: "#d97706" };
  ...
  if (type === "component" || type === "cloud") return { ...common, fill: "#eff6ff", stroke: "#2563eb" };
...
function approvalTemplate(): TemplateData {
  return {
    ...
    nodes: [
      ...
      { id: "decision", text: "是否通过", type: "decision", x: 520, y: 100, width: 130, height: 96 },
...
function decisionTemplate(): TemplateData {
  return {
    ...
    edges: [
      { from: "start", to: "check" },
      { from: "check", to: "yes", label: "是" },
      { from: "check", to: "no", label: "否" },
      { from: "yes", to: "end" },
      { from: "no", to: "end" },
    ],
  };
...
function workOrderTemplate(): TemplateData {
  return {
    ...
    nodes: [
      ...
      { id: "dispatch", text: "分派处理人", type: "process", x: 300, y: 150, width: 130, height: 56 },
      { id: "handle", text: "处理问题", type: "process", x: 520, y: 150, width: 120, height: 56 },
      { id: "resolved", text: "是否解决", type: "decision", x: 720, y: 128, width: 130, height: 96 },
    ...
    edges: [
      ...
      { from: "resolved", to: "confirm", label: "是" },
      { from: "resolved", to: "rework", label: "否" },
      { from: "confirm", to: "close" },
      { from: "rework", to: "handle" },
    ],
  };
}
...
function crmTemplate(): TemplateData {
  return {
    ...
    nodes: [
      ...
      { id: "intent", text: "是否有意向", type: "decision", x: 520, y: 128, width: 130, height: 96 },
      { id: "opportunity", text: "建立商机", type: "process", x: 740, y: 90, width: 120, height: 56 },
    ...
    edges: [
      ...
      { from: "intent", to: "opportunity", label: "是" },
      { from: "intent", to: "lost", label: "否" },
...
function loginTemplate(): TemplateData {
  return {
    ...
    nodes: [
      ...
      { id: "input", text: "输入账号密码", type: "process", x: 330, y: 120, width: 140, height: 56 },
    ...
    edges: [
      { from: "open", to: "input" },
      { from: "input", to: "valid" },
      { from: "valid", to: "home", label: "是" },
      { from: "valid", to: "error", label: "否" },
      { from: "error", to: "input" },
    ],
  };
}
...
function paymentTemplate(): TemplateData {
  return {
    ...
    edges: [
      ...
      { from: "result", to: "fulfill", label: "是" },
      { from: "result", to: "cancel", label: "否" },
      { from: "fulfill", to: "end" },
    ],
  };
}
...
function bpmnOrderTemplate(): TemplateData {
  return {
    ...
    nodes: [
      ...
      { id: "gateway", text: "库存充足", type: "bpmnGateway", x: 500, y: 128, width: 90, height: 90 },
    ...
    edges: [
      ...
      { from: "gateway", to: "reserve", label: "是" },
      { from: "gateway", to: "wait", label: "否" },
      { from: "reserve", to: "end" },
    ],
  };
}
...
function systemArchitectureTemplate(): TemplateData {
  return {
    ...
    nodes: [
      ...
      { id: "gateway", text: "API Gateway", type: "component", x: 360, y: 160, width: 150, height: 80 },
      { id: "service", text: "业务服务", type: "component", x: 600, y: 100, width: 150, height: 80 },
