...
import { registerDefaultPropertyPanels } from "../../property-panels";
...
export const builtinCorePlugin: EditorPluginModule = {
  manifest: {
    ...
    name: "核心编辑命令",
    version: "1.0.0",
    description: "提供默认命令、右键菜单、顶部操作按钮和属性面板。",
    category: "utility",
    capabilities: ["command", "menu", "action-button", "property-panel"],
